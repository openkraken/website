...
export default defineConfig({
  ...
  styles: [
    ...
    '.__dumi-default-layout-footer-meta { margin-left: 380px !important; margin-right: 200px; padding-bottom: 15px; }',
    '.__dumi-default-layout-footer-meta span { display: none !important }',
  ...
  scripts: [
    ...
    {
      src:
        'https://andycall.oss-cn-beijing.aliyuncs.com/kraken-performance/web-loadtimeList.js',
    },
    {
      src:
        'https://andycall.oss-cn-beijing.aliyuncs.com/kraken-performance/kraken-loadtimeList.js',
    },
  ],
  navs: {
    'zh-CN': [
